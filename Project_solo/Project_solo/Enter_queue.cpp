...
void Game::enter_data_queue()
{
    ...
    printText(20, color["Grey"][0], color["Grey"][1], color["Grey"][2], "Enter the value of each node in the Queue. Separated by Enter.", 450, 20, 0, 0);
    while (true)
    {
        SDL_Event e;
        SDL_PollEvent(&e);
